...
[![GoDoc](https://godoc.org/github.com/bwhour/go-grpc/lib/grpc?status.svg)](https://godoc.org/github.com/bwhour/go-grpc/lib/grpc)
...
```
$ go get -u github.com/bwhour/go-grpc/lib/grpc
```

With Go module support (Go 1.11+), simply `import "github.com/bwhour/go-grpc/lib/grpc"` in
...
Documentation
-------------
- See [godoc](https://godoc.org/github.com/bwhour/go-grpc/lib/grpc) for package and API
  descriptions.
...
```
$ go get -u github.com/bwhour/go-grpc/lib/grpc
package github.com/bwhour/go-grpc/lib/grpc: unrecognized import path "github.com/bwhour/go-grpc/lib/grpc" (https fetch: Get https://github.com/bwhour/go-grpc/lib/grpc?go-get=1: dial tcp 216.239.37.1:443: i/o timeout)
```
...
- Without Go module support: `git clone` the repo manually:
  ...
  ```
  git clone https://github.com/grpc/grpc-go.git $GOPATH/src/github.com/bwhour/go-grpc/lib/grpc
  ```
...
- With Go module support: it is possible to use the `replace` feature of `go
  ...
  ```
  go mod edit -replace=github.com/bwhour/go-grpc/lib/grpc=github.com/grpc/grpc-go@latest
  go mod tidy
  go mod vendor
  go build -mod=vendor
  ```
