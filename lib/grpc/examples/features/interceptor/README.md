...
[`UnaryClientInterceptor`](https://godoc.org/github.com/bwhour/go-grpc/lib/grpc#UnaryClientInterceptor)
...
`DialOption`
[`WithUnaryInterceptor`](https://godoc.org/github.com/bwhour/go-grpc/lib/grpc#WithUnaryInterceptor).

#### Stream Interceptor

[`StreamClientInterceptor`](https://godoc.org/github.com/bwhour/go-grpc/lib/grpc#StreamClientInterceptor)
...
`DialOption`
[`WithStreamInterceptor`](https://godoc.org/github.com/bwhour/go-grpc/lib/grpc#WithStreamInterceptor).
...
[`UnaryServerInterceptor`](https://godoc.org/github.com/bwhour/go-grpc/lib/grpc#UnaryServerInterceptor)
...
`ServerOption`
[`UnaryInterceptor`](https://godoc.org/github.com/bwhour/go-grpc/lib/grpc#UnaryInterceptor).

#### Stream Interceptor

[`StreamServerInterceptor`](https://godoc.org/github.com/bwhour/go-grpc/lib/grpc#StreamServerInterceptor)
...
To install the unary interceptor for a Server, configure `NewServer` with
`ServerOption`
[`StreamInterceptor`](https://godoc.org/github.com/bwhour/go-grpc/lib/grpc#StreamInterceptor).