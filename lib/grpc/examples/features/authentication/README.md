...
[`credentials.PerRPCCredentials`](https://godoc.org/github.com/bwhour/go-grpc/lib/grpc/credentials#PerRPCCredentials).
...
https://godoc.org/github.com/bwhour/go-grpc/lib/grpc/credentials/oauth for details.

#### Client

On client side, users should first get a valid oauth token, and then call
[`credentials.NewOauthAccess`](https://godoc.org/github.com/bwhour/go-grpc/lib/grpc/credentials/oauth#NewOauthAccess)
...
[`WithPerRPCCredentials`](https://godoc.org/github.com/bwhour/go-grpc/lib/grpc#WithPerRPCCredentials).
Or, if user wants to apply OAuth token per call, then configure the grpc RPC
call with `CallOption`
[`PerRPCCredentials`](https://godoc.org/github.com/bwhour/go-grpc/lib/grpc#PerRPCCredentials).
...
[`metadata.FromIncomingContext`](https://godoc.org/github.com/bwhour/go-grpc/lib/grpc/metadata#FromIncomingContext)
