...
```shell
$ go get github.com/bwhour/go-grpc/lib/grpc
```

Then change your current directory to `grpc-go/examples/route_guide`:
```shell
$ cd $GOPATH/src/github.com/bwhour/go-grpc/lib/grpc/examples/route_guide
```
...
`$GOPATH/src/github.com/bwhour/go-grpc/lib/grpc/examples/route_guide`, simply:
